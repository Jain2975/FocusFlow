...
const PomodoroTimer = ({ isGuestMode }) => {
  ...
  const sessionConfig = {
    work: { time: 25 * 60, label: "Focus Time", color: "stroke-focus" },
    break: { time: 5 * 60, label: "Short Break", color: "stroke-primary" },
    longBreak: { time: 15 * 60, label: "Long Break", color: "stroke-meditation" }
  };
          ...
          >
            <Card className="p-8 text-center bg-card/80 backdrop-blur-sm border-border/50">
              ...
              <div className="flex justify-center space-x-4 mb-6">
                <Button
                  variant={isActive ? "outline" : "focus"}
                  size="lg"
                  onClick={toggleTimer}
                  className="min-w-32"
                >
              ...
              <div className="flex justify-center space-x-2">
                <Button
                  variant={currentSession === 'work' ? 'focus' : 'ghost'}
                  size="sm"
                ...
                <Button
                  variant={currentSession === 'break' ? 'zen' : 'ghost'}
                  size="sm"
                ...
                <Button
                  variant={currentSession === 'longBreak' ? 'meditation' : 'ghost'}
                  size="sm"
            ...
            <Card className="p-6 bg-card/80 backdrop-blur-sm border-border/50">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-foreground">
                    {isGuestMode ? "Sign in to track" : "3 days"}
                  </span>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6 bg-card/80 backdrop-blur-sm border-border/50">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-foreground">25 min</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            {isGuestMode && (
              <Card className="p-6 bg-gradient-zen/10 border-primary/20 backdrop-blur-sm">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Sign in to save your progress and access custom timer settings.
                </p>
