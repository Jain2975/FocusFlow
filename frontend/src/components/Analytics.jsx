...
Promise.all([fetchWeeklyTrends, fetchProductivityDistribution, fetchDailyMood, fetchStats, fetchAchievements])
  ...
  // Hardcoded stats and achievements (can later be dynamic)
  // const stats = [
  //   { label: "Total Focus Time", value: "42.5h", change: "+15%", icon: Clock, color: "text-focus" },
  //   { label: "Completed Sessions", value: "87", change: "+23%", icon: Target, color: "text-primary" },
  //   { label: "Meditation Minutes", value: "180", change: "+8%", icon: Brain, color: "text-meditation" },
  //   { label: "Tasks Completed", value: "124", change: "+12%", icon: Award, color: "text-accent" }
  // ];
            ...
            <Card className="p-6 bg-card/80 backdrop-blur-sm border-border/50">
              ...
              <ResponsiveContainer width="100%" height={250}>
                <LineChart data={dailyMood}>
                  ...
                  <Line type="monotone" dataKey="energy" stroke="hsl(var(--meditation))" strokeWidth={3} dot={{ fill: "hsl(var(--meditation))", r: 4 }} />
                </LineChart>
              </ResponsiveContainer>
            </Card>
          </div>
